...
uint32_t init_RIT ( uint32_t RITInterval )
{
  ...
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL1 |= (1<<26);
 ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCONP |= (1<<16);

 ((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )->RICOMPVAL = RITInterval;
 ((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )->RICTRL = (1<<1) |
            (1<<2) ;
 ((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )->RICOUNTER = 0;
